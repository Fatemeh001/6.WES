...
# Load the dataset (WEC_Perth_49)
file_path = 'dataset/WEC_Perth_49.csv'
data = pd.read_csv(file_path)

# Extract coordinates and power data
x = data['X1']  # Replace 'X1' with the actual column for X-coordinates
y = data['Y1']  # Replace 'Y1' with the actual column for Y-coordinates
power = data['Power1']  # Replace 'Power1' with the actual column for power
...
chart = lc.Chart3D(
    ...
    title='Power Distribution: Perth Wave Scenario (49 Buoy)'
)
